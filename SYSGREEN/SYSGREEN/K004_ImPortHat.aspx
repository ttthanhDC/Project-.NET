<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="K004_ImPortHat.aspx.cs" Inherits="SYSGREEN.K004_ImPortHat" %>
...
<script>
    ...
    var eventSearch1 = function () {
        ...
        formDatasearch.append('TypeXNK', 0);
            ...
            success: function (result) {
                ...
                if (jsonData && jsonData.length > 0) {
                    for (var i = 0; i < jsonData.length ; i++) {
                        ...
                        obj.phieuXuat = objectData.MaPhieuNhap;
