<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="KT004_Detail.aspx.cs" Inherits="SYSGREEN.KT004_Detail" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolderMenu2" runat="server">
    <div style ="text-align:center">
        ...
        <div class="row">
                ...
                <div class="col-md-3">
                    <select class="form-control" id="txt_TkThu">
                        <option value = 0 ></option>
                        <option value = 1 >VCB</option>
                        <option value = 2 >BIDV</option>
                        <option value = 3 >TCB</option>
...
<script>
    $(document).ready(function () {
        ...
        if (window.id !== "Add") {
            ...
            $.ajax({
                ...
                success: function (result) {
                    var obj = result[0];
                    $('#txt_TkChi').val(obj.NAME);
                    $('#txt_monny').val(obj.DiaChi);
                    $('#txt_TkThu').val(obj.DESCRIPTION);
        ...
        $('#btBack').on('click', function (e) {
            window.location = '/KT004_CashFlow.aspx?paramId= 0';
        });
        // save
