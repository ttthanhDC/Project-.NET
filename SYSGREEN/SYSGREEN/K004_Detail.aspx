<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="K004_Detail.aspx.cs" Inherits="SYSGREEN.K004_Detail" %>
   ...
   <script>
       $(function () {
           ...
           if (window.idParam === "ADD") {
               ...
               formDataListUser.append('TypeXNK', 0);
