<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="C009_Detail.aspx.cs" Inherits="SYSGREEN.managerPoromotion" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolderMenu2" runat="server">
   ...
   <div class="form-group">
        ...
        <div class="col-md-9">
           <input type="text" class="form-control" name="bigin date" id="date_bigin" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-3 control-label">Ngày kết thúc</label>
        <div class="col-md-9">
            <input type="text" class="form-control" name="end date" id="date_end" />
        </div>
    </div> 
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <input type="text" class="form-control" name="create date" id="date_create" />
        </div>
    </div>
    <div class="form-group">
   ...
   <script>
       ...
       $(document).ready(function () {
                   ...
                   success: function (result) {
                       ...
                       if (jsonData && jsonData.length > 0) {
                           for (var i = 0; i < jsonData.length ; i++) {
                               ...
                               var Date_Start = objectData.Date_Start;
                               var a = "";
                               if (Date_Start) {
                               ...
                               var Create_Date = objectData.Create_Date;
                               var c= "";
                               if (Create_Date) {
                                   var x = Create_Date.substr(0, 10);
                                   var y = x.split("-");
                                   var y1 = y[0];
                                   var y2 = y[1];
                                   var y3 = y[2];
           ...
           $('#btnBack').on('click', function (e) {
               window.location = '/C009_TotalBill.aspx?paramId= 0';
           });
