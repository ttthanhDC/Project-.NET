    ...
    public class KhoServices
    {
        ...
        public static void insertOrUpdateViewK001(String Ngay, String ID,String productName,String ProductId,String productUnit,String productUnit_DK,String productUnit_CL)
        {
            ...
            if (check > 0)
            {
                ...
                cmdUpdate.Parameters.Add("@productUnit", Convert.ToInt16(productUnit));
                cmdUpdate.Parameters.Add("@productUnit_DK", Convert.ToInt16(productUnit_DK));
                cmdUpdate.Parameters.Add("@productUnit_CL", Convert.ToInt16(productUnit_CL));
                cmdUpdate.Parameters.Add("@ID", Convert.ToInt16(ID));
                conn.Open();
            ...
            else
            {
                ...
                cmdUpdate.CommandType = CommandType.Text;
                cmdUpdate.Connection = conn;
                cmdUpdate.Parameters.Add("@Product_Name", productName);
                cmdUpdate.Parameters.Add("@Product_ID", Convert.ToInt16(ProductId));
                cmdUpdate.Parameters.Add("@Product_Unit", Convert.ToInt16(productUnit));
                cmdUpdate.Parameters.Add("@Product_Unit_DK", Convert.ToInt16(productUnit_DK));
                cmdUpdate.Parameters.Add("@Product_Unit_CL", Convert.ToInt16(productUnit_CL));
                cmdUpdate.Parameters.Add("@Product_Unit_CL", Convert.ToInt16(productUnit_CL));
                cmdUpdate.Parameters.Add("@Ngay", DateTime.ParseExact(Ngay, "dd/MM/yyyy", CultureInfo.InvariantCulture));
                conn.Open();
                cmdUpdate.ExecuteNonQuery();
                conn.Close();
            }
